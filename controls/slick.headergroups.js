...
(function ($) {
  function SlickGridHeaderGroups(_grid, _groupsDef) {
    ...
    function onResize() {
        ...
        categories.forEach(function (row) {
            var $spanHeaders = $("<div class='slick-header-columns slick-header-column-groups' />")
    ...
    function getCategories(cols, groupsDef, memo) {
        ...
        if (currentLevel.filter(function (c) { 
                                    return groupsDef[c.field] && groupsDef[c.field].group != null; 
                                }).length > 0) {
  ...
  $.extend(true, window, { 
    Slick: { 
        Controls: { 
            HeaderGroups: SlickGridHeaderGroups 
        }
    }
  });
})(jQuery);

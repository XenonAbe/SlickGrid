...
(function ($) {
    ...
    function SlickGrid(container, data, columns, options) {
        ...
        function getMinVisibleRows() {
            return Math.ceil(getViewportHeight() / options.rowHeight);
        }
        ...
        function makeActiveCellEditable(editor, e) {
            ...
            if (trigger(self.onBeforeEditCell, {row: activeRow, cell: activeCell, item: item, column: columnDef, grid: self, ev: e}) === false) {
                setFocus();
                return;
            }
        ...
        function commitEditAndSetFocus(e) {
